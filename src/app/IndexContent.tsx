                                ...
                                (() => {
                                  ...
                                  return spotifySongs.map((song, i) => {
                                    ...
                                    <TableRow key={i} className="group border-b last:border-0">
                                      <TableCell title={song.title} className="py-2 text-[11px] font-medium leading-tight max-w-[200px] truncate">{song.title}</TableCell>
                                      <TableCell title={song.artist} className="py-2 text-[10px] text-muted-foreground uppercase truncate">{song.artist}</TableCell>
