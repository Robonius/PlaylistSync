...
4. Copy the **Client ID** and **Client Secret** and add them to your `.env` as `SPOTIFY_CLIENT_ID` and `ROBOLAB_SPOTIFY_CLIENT_SECRET`.
...
8. Copy the **Client ID** and **Client Secret** and add them to your `.env` as `GOOGLE_CLIENT_ID` and `ROBOLAB_GOOGLE_CLIENT_SECRET`.
...
- `SPOTIFY_CLIENT_ID`
- `ROBOLAB_SPOTIFY_CLIENT_SECRET`
- `GOOGLE_CLIENT_ID`
- `ROBOLAB_GOOGLE_CLIENT_SECRET`
- `REDIRECT_URI`
